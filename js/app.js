...
<a href="#" style="color:blue;">Anthem.mp3</a>                       3.2M</pre>
    ...
    function updateMailAccountStrip() {
        ...
        if (mailReplyBtn) mailReplyBtn.disabled = disabled || !mailSelectedId || mailBusy;
        if (mailDeleteBtn) mailDeleteBtn.disabled = disabled || !mailSelectedId || mailBusy;
    }
    ...
    async function loadMail(force = false) {
        ...
        try {
            ...
            mailData = Array.isArray(data.messages) ? data.messages : [];
