...
export function fixture() {
    ...
    const store = {
        ...
        async setJSON(key, data, options) {
            ...
            records.set(key, { data: structuredClone(data), etag: randomUUID() });
    ...
    return { records, identity, store, handler, call: (method = 'GET', body = null, id = '') => handler(new Request(`https://site.test/api/artist-drafts${id ? `?id=${id}` : ''}`, {
